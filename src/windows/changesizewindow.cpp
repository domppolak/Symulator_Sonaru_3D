...
void ChangeSizeWindow::setTitleDependOnObj(const Objects &obj)
{
    switch(obj)
    {
        case PLATFORM:
            setWindowTitle("Platform size");
            ui->label_4->setText("Platform size:");
            ui->label->show();
            ui->label_2->show();
            ui->label_3->show();
            ui->ySpinBox->show();
        ...
        case POINT:
            ...
            break;
        case STAKE:
            setWindowTitle("Stake size");
            ui->label_4->setText("Stake size:");
            ui->label->hide();
            ui->label_2->hide();
            ui->label_3->hide();
            ui->ySpinBox->hide();
            ...
            break;
        case FLAT_SURFACE:
            setWindowTitle("Flat surface size");
