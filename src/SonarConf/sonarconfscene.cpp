...
void SonarConfScene::createReceiver(uint id)
{
    ...
    rec->scale(QVector3D(0.5, 0.5, 1.25));
...
void SonarConfScene::createTransmitter(QVector3D sonarScale)
{
    ...
    transmitterModel->scale(0.5, 0.5, 0.5);
...
{
    transmitterModel->scale(newScale);
}
